...
The [issue tracker](https://github.com/LeonardoGentile/babel-starter-kit/issues) is the preferred channel
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git remote add upstream https://github.com/LeonardoGentile/babel-starter-kit.git
   # install deps
   npm install
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit message guidelines](https://github.com/angular/angular.js/blob/master/CONTRIBUTING.md#-git-commit-guidelines)
   ...
   npm run commit
   ```
   This will run the npm script `commit` from `packages.json` and will prompt you questions about your 
